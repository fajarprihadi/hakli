...
@Entity
public class Tp2kbd02 {
	
	private Integer tp2kbd02pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbd02_seq", sequenceName = "tp2kbd02_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbd02_seq")
	public Integer getTp2kbd02pk() {
		return tp2kbd02pk;
	}

	public void setTp2kbd02pk(Integer tp2kbd02pk) {
		this.tp2kbd02pk = tp2kbd02pk;
	}
	...
	@Type(type = "com.sds.utils.usertype.TrimUserType")
	public String getTipepublikasi() {
		return tipepublikasi;
	}

	public void setTipepublikasi(String tipepublikasi) {
