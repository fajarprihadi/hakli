...
@Entity
public class Tp2kbc01 {
	
	private Integer tp2kbc01pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbc01_seq", sequenceName = "tp2kbc01_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbc01_seq")
	public Integer getTp2kbc01pk() {
		return tp2kbc01pk;
	}

	public void setTp2kbc01pk(Integer tp2kbc01pk) {
		this.tp2kbc01pk = tp2kbc01pk;
	}
