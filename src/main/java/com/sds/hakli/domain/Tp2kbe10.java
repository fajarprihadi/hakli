...
@Entity
public class Tp2kbe10 {
	
	private Integer tp2kbe10pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbe10_seq", sequenceName = "tp2kbe10_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbe10_seq")
	public Integer getTp2kbe10pk() {
		return tp2kbe10pk;
	}

	public void setTp2kbe10pk(Integer tp2kbe10pk) {
		this.tp2kbe10pk = tp2kbe10pk;
	}
