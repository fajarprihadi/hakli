...
@Entity
public class Tp2kba05 {
	
	private Integer tp2kba05pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kba05_seq", sequenceName = "tp2kba05_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kba05_seq")
	public Integer getTp2kba05pk() {
		return tp2kba05pk;
	}

	public void setTp2kba05pk(Integer tp2kba05pk) {
		this.tp2kba05pk = tp2kba05pk;
	}
