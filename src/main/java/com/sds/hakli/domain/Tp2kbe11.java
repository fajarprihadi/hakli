...
@Entity
public class Tp2kbe11 {
	
	private Integer tp2kbe11pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbe11_seq", sequenceName = "tp2kbe11_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbe11_seq")
	public Integer getTp2kbe11pk() {
		return tp2kbe11pk;
	}

	public void setTp2kbe11pk(Integer tp2kbe11pk) {
		this.tp2kbe11pk = tp2kbe11pk;
	}
