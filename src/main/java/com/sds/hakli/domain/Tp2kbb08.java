...
@Entity
public class Tp2kbb08 {
	
	private Integer tp2kbb08pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb08_seq", sequenceName = "tp2kbb08_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb08_seq")
	public Integer getTp2kbb08pk() {
		return tp2kbb08pk;
	}

	public void setTp2kbb08pk(Integer tp2kbb08pk) {
		this.tp2kbb08pk = tp2kbb08pk;
	}
