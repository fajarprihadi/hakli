...
@Entity
public class Tp2kbb04 {
	
	private Integer tp2kbb04pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb04_seq", sequenceName = "tp2kbb04_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb04_seq")
	public Integer getTp2kbb04pk() {
		return tp2kbb04pk;
	}

	public void setTp2kbb04pk(Integer tp2kbb04pk) {
		this.tp2kbb04pk = tp2kbb04pk;
	}
