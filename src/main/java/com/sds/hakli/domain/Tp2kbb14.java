...
@Entity
public class Tp2kbb14 {
	
	private Integer tp2kbb14pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb14_seq", sequenceName = "tp2kbb14_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb14_seq")
	public Integer getTp2kbb14pk() {
		return tp2kbb14pk;
	}

	public void setTp2kbb14pk(Integer tp2kbb14pk) {
		this.tp2kbb14pk = tp2kbb14pk;
	}
