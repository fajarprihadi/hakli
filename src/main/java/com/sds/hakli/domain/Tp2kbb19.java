...
@Entity
public class Tp2kbb19 {
	
	private Integer tp2kbb19pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb19_seq", sequenceName = "tp2kbb19_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb19_seq")
	public Integer getTp2kbb19pk() {
		return tp2kbb19pk;
	}

	public void setTp2kbb19pk(Integer tp2kbb19pk) {
		this.tp2kbb19pk = tp2kbb19pk;
	}
