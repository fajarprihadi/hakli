...
@Entity
public class Tp2kbe02 {
	
	private Integer tp2kbe02pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbe02_seq", sequenceName = "tp2kbe02_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbe02_seq")
	public Integer getTp2kbe02pk() {
		return tp2kbe02pk;
	}

	public void setTp2kbe02pk(Integer tp2kbe02pk) {
		this.tp2kbe02pk = tp2kbe02pk;
	}
