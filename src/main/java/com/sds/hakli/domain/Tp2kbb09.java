...
@Entity
public class Tp2kbb09 {
	
	private Integer tp2kbb09pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb09_seq", sequenceName = "tp2kbb09_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb09_seq")
	public Integer getTp2kbb09pk() {
		return tp2kbb09pk;
	}

	public void setTp2kbb09pk(Integer tp2kbb09pk) {
		this.tp2kbb09pk = tp2kbb09pk;
	}
