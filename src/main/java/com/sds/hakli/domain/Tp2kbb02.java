...
@Entity
public class Tp2kbb02 {
	
	private Integer tp2kbb02pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb02_seq", sequenceName = "tp2kbb02_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb02_seq")
	public Integer getTp2kbb02pk() {
		return tp2kbb02pk;
	}

	public void setTp2kbb02pk(Integer tp2kbb02pk) {
		this.tp2kbb02pk = tp2kbb02pk;
	}
