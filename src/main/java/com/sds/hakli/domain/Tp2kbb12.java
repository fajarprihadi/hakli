...
@Entity
public class Tp2kbb12 {
	
	private Integer tp2kbb12pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb12_seq", sequenceName = "tp2kbb12_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb12_seq")
	public Integer getTp2kbb12pk() {
		return tp2kbb12pk;
	}

	public void setTp2kbb12pk(Integer tp2kbb12pk) {
		this.tp2kbb12pk = tp2kbb12pk;
	}
