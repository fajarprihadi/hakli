...
@Entity
public class Tp2kbb11 {
	
	private Integer tp2kbb11pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb11_seq", sequenceName = "tp2kbb11_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb11_seq")
	public Integer getTp2kbb11pk() {
		return tp2kbb11pk;
	}

	public void setTp2kbb11pk(Integer tp2kbb11pk) {
		this.tp2kbb11pk = tp2kbb11pk;
	}
