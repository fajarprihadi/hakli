...
@Entity
public class Tp2kbb15 {
	
	private Integer tp2kbb15pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb15_seq", sequenceName = "tp2kbb15_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb15_seq")
	public Integer getTp2kbb15pk() {
		return tp2kbb15pk;
	}

	public void setTp2kbb15pk(Integer tp2kbb15pk) {
		this.tp2kbb15pk = tp2kbb15pk;
	}
