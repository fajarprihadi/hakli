...
@Entity
public class Tp2kbb01 {
	
	private Integer tp2kbb01pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb01_seq", sequenceName = "tp2kbb01_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb01_seq")
	public Integer getTp2kbb01pk() {
		return tp2kbb01pk;
	}

	public void setTp2kbb01pk(Integer tp2kbb01pk) {
		this.tp2kbb01pk = tp2kbb01pk;
	}
