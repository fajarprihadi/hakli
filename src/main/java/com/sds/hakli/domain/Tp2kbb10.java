...
@Entity
public class Tp2kbb10 {
	
	private Integer tp2kbb10pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb10_seq", sequenceName = "tp2kbb10_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb10_seq")
	public Integer getTp2kbb10pk() {
		return tp2kbb10pk;
	}

	public void setTp2kbb10pk(Integer tp2kbb10pk) {
		this.tp2kbb10pk = tp2kbb10pk;
	}
