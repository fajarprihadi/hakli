...
@Entity
public class Tp2kbb17 {
	
	private Integer tp2kbb17pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb17_seq", sequenceName = "tp2kbb17_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb17_seq")
	public Integer getTp2kbb17pk() {
		return tp2kbb17pk;
	}

	public void setTp2kbb17pk(Integer tp2kbb17pk) {
		this.tp2kbb17pk = tp2kbb17pk;
	}
