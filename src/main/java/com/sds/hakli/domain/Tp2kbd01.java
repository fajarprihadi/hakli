...
@Entity
public class Tp2kbd01 {
	
	private Integer tp2kbd01pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbd01_seq", sequenceName = "tp2kbd01_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbd01_seq")
	public Integer getTp2kbd01pk() {
		return tp2kbd01pk;
	}

	public void setTp2kbd01pk(Integer tp2kbd01pk) {
		this.tp2kbd01pk = tp2kbd01pk;
	}
