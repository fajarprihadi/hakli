...
@Entity
public class Tp2kbe05 {
	
	private Integer tp2kbe05pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbe05_seq", sequenceName = "tp2kbe05_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbe05_seq")
	public Integer getTp2kbe05pk() {
		return tp2kbe05pk;
	}

	public void setTp2kbe05pk(Integer tp2kbe05pk) {
		this.tp2kbe05pk = tp2kbe05pk;
	}
