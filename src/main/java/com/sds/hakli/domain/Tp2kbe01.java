...
@Entity
public class Tp2kbe01 {
	
	private Integer tp2kbe01pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbe01_seq", sequenceName = "tp2kbe01_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbe01_seq")
	public Integer getTp2kbe01pk() {
		return tp2kbe01pk;
	}

	public void setTp2kbe01pk(Integer tp2kbe01pk) {
		this.tp2kbe01pk = tp2kbe01pk;
	}
