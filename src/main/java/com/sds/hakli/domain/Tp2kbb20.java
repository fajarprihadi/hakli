...
@Entity
public class Tp2kbb20 {
	
	private Integer tp2kbb20pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb20_seq", sequenceName = "tp2kbb20_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb20_seq")
	public Integer getTp2kbb20pk() {
		return tp2kbb20pk;
	}

	public void setTp2kbb20pk(Integer tp2kbb20pk) {
		this.tp2kbb20pk = tp2kbb20pk;
	}
