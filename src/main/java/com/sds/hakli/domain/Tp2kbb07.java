...
@Entity
public class Tp2kbb07 {
	
	private Integer tp2kbb07pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbb07_seq", sequenceName = "tp2kbb07_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbb07_seq")
	public Integer getTp2kbb07pk() {
		return tp2kbb07pk;
	}

	public void setTp2kbb07pk(Integer tp2kbb07pk) {
		this.tp2kbb07pk = tp2kbb07pk;
	}
