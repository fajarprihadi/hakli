...
@Entity
public class Tp2kba04 {
	
	private Integer tp2kba04pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kba04_seq", sequenceName = "tp2kba04_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kba04_seq")
	public Integer getTp2kba04pk() {
		return tp2kba04pk;
	}

	public void setTp2kba04pk(Integer tp2kba04pk) {
		this.tp2kba04pk = tp2kba04pk;
	}
	...
	public Integer getJumlahjpl() {
		return jumlahjpl;
	}

	public void setJumlahjpl(Integer jumlahjpl) {
