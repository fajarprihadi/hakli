...
@Entity
public class Tp2kbe06 {
	
	private Integer tp2kbe06pk;
	...
	@Id
	@SequenceGenerator(name = "tp2kbe06_seq", sequenceName = "tp2kbe06_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tp2kbe06_seq")
	public Integer getTp2kbe06pk() {
		return tp2kbe06pk;
	}

	public void setTp2kbe06pk(Integer tp2kbe06pk) {
		this.tp2kbe06pk = tp2kbe06pk;
	}
