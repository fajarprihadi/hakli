...
public class P2kbE02DetailVm {
	...
	@Wire
	private Window winP2kbe02Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbe02>() {

			@Override
			public void render(Row row, Tp2kbe02 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbE02DetailVm.this, "totalskp");
											}
										}
									});
						} else {
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbe02 obj, String action, String memotim) {
		try {
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbe02> objList = oDao.listByFilter(filter, "tp2kbe02pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbe02 obj) {
	...
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbe02 obj) {
						...
						if (event.getName().equals("onOK")) {
							...
							try {
								...
								Clients.showNotification("Proses hapus data berhasil", "info", null, "middle_center",
										1500);
								doRefresh();
								BindUtils.postNotifyChange(P2kbE02DetailVm.this, "*");
							} catch (Exception e) {
