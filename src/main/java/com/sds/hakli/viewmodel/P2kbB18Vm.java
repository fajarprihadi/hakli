...
public class P2kbB18Vm {
	...
	@Wire
	private Window winP2kbb18;
	
	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, 
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbb18 objForm,
	...
	public void doSave() {
		...
		try {
			...
			if (isInsert) {
				Clients.showNotification("Proses simpan data berhasil", "info", null, "middle_center", 1800);
			} else {
				Clients.showNotification("Proses pembaruan data berhasil", "info", null, "middle_center", 1800);
			}
	...
	public BigDecimal getNilaiSkp(Tp2kbb18 obj) throws Exception {
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbb18, map);
	...
	public Tp2kbb18 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbb18 objForm) {
		this.objForm = objForm;
	}
