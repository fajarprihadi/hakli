...
public class P2kbD01Vm {
	...
	@Wire
	private Window winP2kbd01;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbd01 objForm,
	...
	public void doSave() {
		if (objForm.getTglkegiatan().compareTo(tpb.getTglmulai()) >= 0
			...
			try {
				...
				objForm.setNilaiskp(new BigDecimal(2));
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbd01, map);
	...
	public Tp2kbd01 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbd01 objForm) {
		this.objForm = objForm;
	}
