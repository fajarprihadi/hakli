...
public class P2kbB03DetailVm {
	...
	@Wire
	private Window winP2kbb03Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbb03>() {

			@Override
			public void render(Row row, Tp2kbb03 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbB03DetailVm.this, "totalskp");
											}
										}
									});
						} else {
				...
				Label lbl1 = new Label("Jenis Jabatan");
				lbl1.setStyle("font-weight: bold");
				divKegiatan1.appendChild(lbl1);
				Label lbl2 = new Label(": " + data.getJenisjabatan());
				...
				Label lbl3 = new Label("Nama Jabatan");
				lbl3.setStyle("font-weight: bold");
				divKegiatan2.appendChild(lbl3);
				Label lbl4 = new Label(": " + data.getNamajabatan());
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbb03 obj, String action, String memotim) {
		try {
			...
			new Tp2kbB03DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbb03> objList = oDao.listByFilter(filter, "tp2kbb03pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbb03 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbb03.zul");
		map.put("p2kb", obj);
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbb03Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbb03 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbB03DetailVm.this, "*");
					} catch (Exception e) {
