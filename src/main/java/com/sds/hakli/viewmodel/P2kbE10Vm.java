...
public class P2kbE10Vm {
	...
	public BigDecimal getNilaiSkp(Tp2kbe10 obj) throws Exception {
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbe10, map);
	...
	public Tp2kbe10 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbe10 objForm) {
		this.objForm = objForm;
	}
