...
public class P2kbB12Vm {
	
	private org.zkoss.zk.ui.Session zkSession = Sessions.getCurrent();
	private Tanggota anggota;
	private Tp2kbB12DAO oDao = new Tp2kbB12DAO();
	...
	@Wire
	private Window winP2kbb12;
	
	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, 
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbb12 objForm,
	...
	public BigDecimal getNilaiSkp(Tp2kbb12 obj) throws Exception {
		BigDecimal skp = new BigDecimal(0);
		if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor permanen") && obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor permanen") && obj.getStatuspeserta().equals("Anggota Tim")) {
			skp = new BigDecimal(2);
		} else if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor permanen") && obj.getStatuspeserta().equals("Kontributor")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor Sementara") && obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor Sementara") && obj.getStatuspeserta().equals("Anggota Tim")) {
			skp = new BigDecimal(2);
		} else if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor Sementara") && obj.getStatuspeserta().equals("Kontributor")) {
			skp = new BigDecimal(1);
		}
		return skp;
	}
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbb12, map);
	...
	public Tp2kbb12 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbb12 objForm) {
		this.objForm = objForm;
	}
