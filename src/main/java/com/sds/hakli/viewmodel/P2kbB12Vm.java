...
public class P2kbB12Vm {
	...
	public BigDecimal getNilaiSkp(Tp2kbb12 obj) throws Exception {
		...
		if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor permanen")
				&& obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor permanen")
				&& obj.getStatuspeserta().equals("Anggota Tim")) {
			skp = new BigDecimal(2);
		} else if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor permanen")
				&& obj.getStatuspeserta().equals("Kontributor")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor Sementara")
				&& obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Mengubah Habitat Perkembangbiakan Vektor Sementara")
				&& obj.getStatuspeserta().equals("Anggota Tim")) {
