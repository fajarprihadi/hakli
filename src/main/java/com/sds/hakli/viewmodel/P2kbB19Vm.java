...
public class P2kbB19Vm {
	...
	@Wire
	private Window winP2kbb19;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbb19 objForm,
	...
	public void doSave() {
		if (objForm.getTglmulai().compareTo(tpb.getTglmulai()) >= 0
			...
			try {
				...
				if (isInsert) {
					Clients.showNotification("Proses simpan data berhasil", "info", null, "middle_center", 1900);
				} else {
					Clients.showNotification("Proses pembaruan data berhasil", "info", null, "middle_center", 1900);
				}
	...
	public BigDecimal getNilaiSkp(Tp2kbb19 obj) throws Exception {
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbb19, map);
	...
	public Tp2kbb19 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbb19 objForm) {
		this.objForm = objForm;
	}
