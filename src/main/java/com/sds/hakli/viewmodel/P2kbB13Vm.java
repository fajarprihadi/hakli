...
public class P2kbB13Vm {
	...
	@Wire
	private Window winP2kbb13;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbb13 objForm,
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbb13, map);
	...
	public Tp2kbb13 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbb13 objForm) {
		this.objForm = objForm;
	}
