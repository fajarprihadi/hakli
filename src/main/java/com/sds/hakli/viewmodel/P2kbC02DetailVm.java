...
public class P2kbC02DetailVm {
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbc02 obj, String action, String memotim) {
		try {
			...
			new Tp2kbC02DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbc02> objList = oDao.listByFilter(filter, "tp2kbc02pk desc");
