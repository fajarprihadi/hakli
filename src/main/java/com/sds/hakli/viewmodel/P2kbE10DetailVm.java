...
public class P2kbE10DetailVm {
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbe10 obj, String action, String memotim) {
		try {
			...
			new Tp2kbE10DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbe10> objList = oDao.listByFilter(filter, "tp2kbe10pk desc");
