...
public class P2kbB19DetailVm {
	
	private org.zkoss.zk.ui.Session zkSession = Sessions.getCurrent();
	private Tanggota anggota;
	private Tp2kbB19DAO oDao = new Tp2kbB19DAO();
	...
	@Wire
	private Window winP2kbb19Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbb19>() {

			@Override
			public void render(Row row, Tp2kbb19 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbB19DetailVm.this, "totalskp");
											}
										}
									});
						} else {
				...
				Label lbl1 = new Label("Jenis Limbah");
				lbl1.setStyle("font-weight: bold");
				divKegiatan1.appendChild(lbl1);
				Label lbl2 = new Label(": " + data.getJenislimbah());
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbb19 obj, String action, String memotim) {
		try {
			...
			new Tp2kbB19DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbb19> objList = oDao.listByFilter(filter, "tp2kbb19pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbb19 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbb19.zul");
		map.put("p2kb", obj);
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbb19Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbb19 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbB19DetailVm.this, "*");
					} catch (Exception e) {
