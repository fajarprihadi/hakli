...
public class P2kbB20DetailVm {
	...
	@Wire
	private Window winP2kbb20Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbb20>() {

			@Override
			public void render(Row row, Tp2kbb20 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbB20DetailVm.this, "totalskp");
											}
										}
									});
						} else {
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbb20 obj, String action, String memotim) {
		try {
			...
			new Tp2kbB20DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbb20> objList = oDao.listByFilter(filter, "tp2kbb20pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbb20 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbb20.zul");
		map.put("p2kb", obj);
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbb20Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbb20 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbB20DetailVm.this, "*");
					} catch (Exception e) {
