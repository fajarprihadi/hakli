...
public class P2kbB10Vm {
	...
	@Wire
	private Window winP2kbb10;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbb10 objForm,
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbb10, map);
	...
	public Tp2kbb10 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbb10 objForm) {
		this.objForm = objForm;
	}
