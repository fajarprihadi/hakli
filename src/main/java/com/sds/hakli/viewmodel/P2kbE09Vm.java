...
public class P2kbE09Vm {

	private org.zkoss.zk.ui.Session zkSession = Sessions.getCurrent();
	private Tanggota anggota;
	private Tp2kbE09DAO oDao = new Tp2kbE09DAO();
	...
	@Wire
	private Window winP2kbe09;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbe09 objForm,
	...
	public BigDecimal getNilaiSkp(Tp2kbe09 obj) throws Exception {
		BigDecimal skp = new BigDecimal(0);
		if (obj.getArea().equals("Gagasan")) {
			skp = new BigDecimal(1);
		} else if (obj.getArea().equals("Konsep")) {
			skp = new BigDecimal(2);
		} else if (obj.getArea().equals("Praktek")) {
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbe09, map);
	...
	public Validator getValidator() {
		return new AbstractValidator() {
			...
			public void validate(ValidationContext ctx) {
				...
				String statuspeneliti = (String) ctx.getProperties("statuspeneliti")[0].getValue();
				if (statuspeneliti == null || "".equals(statuspeneliti.trim()))
					this.addInvalidMessage(ctx, "statuspeneliti", Labels.getLabel("common.validator.empty"));
	...
	public Tp2kbe09 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbe09 objForm) {
		this.objForm = objForm;
	}
