...
public class P2kbE11DetailVm {
	
	private org.zkoss.zk.ui.Session zkSession = Sessions.getCurrent();
	private Tanggota anggota;
	private Tp2kbE11DAO oDao = new Tp2kbE11DAO();
	...
	@Wire
	private Window winP2kbe11Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbe11>() {

			@Override
			public void render(Row row, Tp2kbe11 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbE11DetailVm.this, "totalskp");
											}
										}
									});
						} else {
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbe11> objList = oDao.listByFilter(filter, "tp2kbe11pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbe11 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbe11.zul");
		map.put("p2kb", obj);
		map.put("book", p2kb.getTp2kbbook());
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbe11Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbe11 obj) {
