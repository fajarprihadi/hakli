...
public class P2kbB17DetailVm {
	...
	@Wire
	private Window winP2kbb17Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbb17>() {

			@Override
			public void render(Row row, Tp2kbb17 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbB17DetailVm.this, "totalskp");
											}
										}
									});
						} else {
				...
				Label lbl3 = new Label("Jenis Jabatan");
				lbl3.setStyle("font-weight: bold");
				divKegiatan2.appendChild(lbl3);
				Label lbl4 = new Label(": " + data.getJenisjabatan());
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbb17 obj, String action, String memotim) {
		try {
			...
			new Tp2kbB17DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbb17> objList = oDao.listByFilter(filter, "tp2kbb17pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbb17 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbb17.zul");
		map.put("p2kb", obj);
		map.put("book", p2kb.getTp2kbbook());
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbb17Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbb17 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbB17DetailVm.this, "*");
					} catch (Exception e) {
