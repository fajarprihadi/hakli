...
public class P2kbE09DetailVm {
	...
	@Wire
	private Window winP2kbe09Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbe09>() {

			@Override
			public void render(Row row, Tp2kbe09 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbE09DetailVm.this, "totalskp");
											}
										}
									});
						} else {
				...
				Label lbl1 = new Label("Judul Penelitian");
				...
				Label lbl3 = new Label("Status Peneliti");
				lbl3.setStyle("font-weight: bold");
				divKegiatan2.appendChild(lbl3);
				Label lbl4 = new Label(": " + data.getStatuspeneliti());
				...
				Label lbl51 = new Label("Nama Institusi");
				lbl51.setStyle("font-weight: bold");
				divKegiatan31.appendChild(lbl51);
				Label lbl61 = new Label(": " + data.getInstitusi());
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbe09 obj, String action, String memotim) {
		try {
			...
			new Tp2kbE09DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbe09> objList = oDao.listByFilter(filter, "tp2kbe09pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbe09 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbe09.zul");
		map.put("p2kb", obj);
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbe09Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbe09 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbE09DetailVm.this, "*");
					} catch (Exception e) {
