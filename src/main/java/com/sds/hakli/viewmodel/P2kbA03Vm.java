...
public class P2kbA03Vm {
	...
	@Wire
	private Window winP2kba03;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kba03 objForm,
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kba03, map);
	...
	public Tp2kba03 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kba03 objForm) {
		this.objForm = objForm;
	}
