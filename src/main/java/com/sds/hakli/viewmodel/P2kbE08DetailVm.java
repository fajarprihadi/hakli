...
public class P2kbE08DetailVm {
	
	private org.zkoss.zk.ui.Session zkSession = Sessions.getCurrent();
	private Tanggota anggota;
	private Tp2kbE08DAO oDao = new Tp2kbE08DAO();
	...
	@Wire
	private Window winP2kbe08Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbe08>() {

			@Override
			public void render(Row row, Tp2kbe08 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbE08DetailVm.this, "totalskp");
											}
										}
									});
						} else {
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbe08 obj, String action, String memotim) {
		try {
			...
			new Tp2kbE08DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbe08> objList = oDao.listByFilter(filter, "tp2kbe08pk desc");
	...
	public void doEdit(Tp2kbe08 obj) {
		...
		map.put("action", "edit");
		map.put("page", "p2kbe08.zul");
		map.put("p2kb", obj);
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbe08Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbe08 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbE08DetailVm.this, "*");
					} catch (Exception e) {
