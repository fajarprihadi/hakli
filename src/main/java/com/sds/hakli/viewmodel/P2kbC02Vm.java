...
public class P2kbC02Vm {
	...
	@Wire
	private Window winP2kbc02;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbc02 objForm,
	...
	public void doSave() {
		if (objForm.getTglkegiatan().compareTo(tpb.getTglmulai()) >= 0
			...
			try {
				objForm.setNilaiskp(new BigDecimal(12));
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbc02, map);
	...
	public Tp2kbc02 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbc02 objForm) {
		this.objForm = objForm;
	}
