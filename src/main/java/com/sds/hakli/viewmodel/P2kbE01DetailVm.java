...
public class P2kbE01DetailVm {
	...
	@Wire
	private Window winP2kbe01Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbe01>() {

			@Override
			public void render(Row row, Tp2kbe01 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbE01DetailVm.this, "totalskp");
											}
										}
									});
						} else {
				...
				Label lbl3 = new Label("Judul Kajian");
				lbl3.setStyle("font-weight: bold");
				divKegiatan2.appendChild(lbl3);
				Label lbl4 = new Label(": " + data.getJudul());
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbe01 obj, String action, String memotim) {
		try {
			...
			new Tp2kbE01DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbe01> objList = oDao.listByFilter(filter, "tp2kbe01pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbe01 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbe01.zul");
		map.put("p2kb", obj);
		map.put("book", p2kb.getTp2kbbook());
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbe01Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbe01 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbE01DetailVm.this, "*");
					} catch (Exception e) {
