...
public class P2kbB06Vm {
	...
	@Wire
	private Window winP2kbb06;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbb06 objForm,
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbb06, map);
	...
	public Tp2kbb06 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbb06 objForm) {
		this.objForm = objForm;
	}
