...
public class P2kbB02Vm {
	...
	@Wire
	private Window winP2kbb02;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbb02 objForm,
	...
	public void doSave() {
		if (objForm.getTglkegiatan().compareTo(tpb.getTglmulai()) >= 0
			...
			try {
				...
				objForm.setNilaiskp(new BigDecimal(10));
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbb02, map);
	...
	public Tp2kbb02 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbb02 objForm) {
		this.objForm = objForm;
	}
