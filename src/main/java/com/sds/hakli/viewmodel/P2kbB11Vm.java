...
public class P2kbB11Vm {
	...
	@Wire
	private Window winP2kbb11;
	
	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, 
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbb11 objForm,
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbb11, map);
	...
	public Tp2kbb11 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbb11 objForm) {
		this.objForm = objForm;
	}
