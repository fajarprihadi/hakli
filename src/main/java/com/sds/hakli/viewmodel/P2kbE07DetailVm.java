...
public class P2kbE07DetailVm {

	private org.zkoss.zk.ui.Session zkSession = Sessions.getCurrent();
	private Tanggota anggota;
	private Tp2kbE07DAO oDao = new Tp2kbE07DAO();
	...
	@Wire
	private Window winP2kbe07Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbe07>() {

			@Override
			public void render(Row row, Tp2kbe07 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbE07DetailVm.this, "totalskp");
											}
										}
									});
						} else {
				...
				Label lbl3 = new Label("Tempat Kegiatan");
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbe07 obj, String action, String memotim) {
		try {
			...
			new Tp2kbE07DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbe07> objList = oDao.listByFilter(filter, "tp2kbe07pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbe07 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbe07.zul");
		map.put("p2kb", obj);
		map.put("book", p2kb.getTp2kbbook());
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbe07Detail, map);
		Events.postEvent(closeEvent);
	}

	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbe07 obj) {
						...
						if (event.getName().equals("onOK")) {
							...
							try {
								...
								Clients.showNotification("Proses hapus data berhasil", "info", null, "middle_center",
										1500);
								doRefresh();
								BindUtils.postNotifyChange(P2kbE07DetailVm.this, "*");
							} catch (Exception e) {
