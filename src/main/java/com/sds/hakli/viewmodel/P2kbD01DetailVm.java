...
public class P2kbD01DetailVm {
	
	private org.zkoss.zk.ui.Session zkSession = Sessions.getCurrent();
	private Tanggota anggota;
	private Tp2kbD01DAO oDao = new Tp2kbD01DAO();
	...
	@Wire
	private Window winP2kbd01Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbd01>() {

			@Override
			public void render(Row row, Tp2kbd01 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbD01DetailVm.this, "totalskp");
											}
										}
									});
						} else {
				...
				Label lbl1 = new Label("Judul Karya Ilmiah");
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbd01 obj, String action, String memotim) {
		try {
			...
			new Tp2kbD01DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbd01> objList = oDao.listByFilter(filter, "tp2kbd01pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbd01 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbd01.zul");
		map.put("p2kb", obj);
		map.put("book", p2kb.getTp2kbbook());
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbd01Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbd01 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbD01DetailVm.this, "*");
					} catch (Exception e) {
