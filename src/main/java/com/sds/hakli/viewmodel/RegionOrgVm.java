...
public class RegionOrgVm {
	...
	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Mprov obj) {
	...
	public void doRefresh() {
		try {
			List<Tanggotaroles> objList = oDao.listByFilter("tanggota.mcabang.mprov.mprovpk = " + objForm.getMprovpk() + " and tanggota.musergroup.usergroupcode = '" + AppUtils.ANGGOTA_ROLE_PENGURUSPROVINSI + "'", "usergroupname, nama");
			int counter = 0;
			String group = null;
