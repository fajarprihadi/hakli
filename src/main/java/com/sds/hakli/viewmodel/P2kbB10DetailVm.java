...
public class P2kbB10DetailVm {
	
	private org.zkoss.zk.ui.Session zkSession = Sessions.getCurrent();
	private Tanggota anggota;
	private Tp2kbB10DAO oDao = new Tp2kbB10DAO();
	...
	@Wire
	private Window winP2kbb10Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbb10>() {

			@Override
			public void render(Row row, Tp2kbb10 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbB10DetailVm.this, "totalskp");
											}
										}
									});
						} else {
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbb10 obj, String action, String memotim) {
		try {
			...
			new Tp2kbB10DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbb10> objList = oDao.listByFilter(filter, "tp2kbb10pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbb10 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbb10.zul");
		map.put("p2kb", obj);
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbb10Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbb10 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbB10DetailVm.this, "*");
					} catch (Exception e) {
