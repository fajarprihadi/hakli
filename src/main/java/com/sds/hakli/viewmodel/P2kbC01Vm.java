...
public class P2kbC01Vm {
	
	private org.zkoss.zk.ui.Session zkSession = Sessions.getCurrent();
	private Tanggota anggota;
	private Tp2kbC01DAO oDao = new Tp2kbC01DAO();
	...
	@Wire
	private Window winP2kbc01;
	
	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, 
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbc01 objForm,
	...
	public BigDecimal getNilaiSkp(Tp2kbc01 obj) throws Exception {
		...
		if (obj.getJeniskegiatan().equals("Pendampingan") && obj.getStatuspeserta().equals("Ketua")) {
			...
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Pemicuan") && obj.getStatuspeserta().equals("Ketua")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Pemicuan") && obj.getStatuspeserta().equals("Anggota")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Inspirator") && obj.getStatuspeserta().equals("Ketua")) {
			skp = new BigDecimal(2);
		} else if (obj.getJeniskegiatan().equals("Inspirator") && obj.getStatuspeserta().equals("Anggota")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Percontohan") && obj.getStatuspeserta().equals("Ketua")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Percontohan") && obj.getStatuspeserta().equals("Anggota")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Tokoh Masyarakat") && obj.getStatuspeserta().equals("Ketua")) {
			skp = new BigDecimal(2);
		} else if (obj.getJeniskegiatan().equals("Tokoh Masyarakat") && obj.getStatuspeserta().equals("Anggota")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Pejabat Non Formal") && obj.getStatuspeserta().equals("Ketua")) {
			skp = new BigDecimal(2);
		} else if (obj.getJeniskegiatan().equals("Pejabat Non Formal") && obj.getStatuspeserta().equals("Anggota")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Lembaga Swadaya Masyarakat") && obj.getStatuspeserta().equals("Ketua")) {
			skp = new BigDecimal(2);
		} else if (obj.getJeniskegiatan().equals("Lembaga Swadaya Masyarakat") && obj.getStatuspeserta().equals("Anggota")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Advokator") && obj.getStatuspeserta().equals("Ketua")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Advokator") && obj.getStatuspeserta().equals("Anggota")) {
			skp = new BigDecimal(1);
		}
		return skp;
	}
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbc01, map);
	...
	public Tp2kbc01 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbc01 objForm) {
		this.objForm = objForm;
	}
