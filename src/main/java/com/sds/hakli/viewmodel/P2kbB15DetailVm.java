...
public class P2kbB15DetailVm {
	...
	@Wire
	private Window winP2kbb15Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbb15>() {

			@Override
			public void render(Row row, Tp2kbb15 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbB15DetailVm.this, "totalskp");
											}
										}
									});
						} else {
				...
				Label lbl1 = new Label("Jenis Penugasan");
				lbl1.setStyle("font-weight: bold");
				divKegiatan1.appendChild(lbl1);
				Label lbl2 = new Label(": " + data.getJenispenugasan());
				...
				Label lbl3 = new Label("Pemberi Tugas");
				lbl3.setStyle("font-weight: bold");
				divKegiatan2.appendChild(lbl3);
				Label lbl4 = new Label(": " + data.getPemberitugas());
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbb15 obj, String action, String memotim) {
		try {
			...
			new Tp2kbB15DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbb15> objList = oDao.listByFilter(filter, "tp2kbb15pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbb15 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbb15.zul");
		map.put("p2kb", obj);
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbb15Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbb15 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbB15DetailVm.this, "*");
					} catch (Exception e) {
