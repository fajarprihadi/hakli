...
public class P2kbE05DetailVm {
	...
	@Wire
	private Window winP2kbe05Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbe05>() {
			...
			@Override
			public void render(Row row, Tp2kbe05 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbE05DetailVm.this, "totalskp");
											}
										}
									});
						} else {
				...
				Label lbl3 = new Label("Jenis Ujian");
				lbl3.setStyle("font-weight: bold");
				divKegiatan2.appendChild(lbl3);
				Label lbl4 = new Label(": " + data.getJenisujian());
				...
				Label lbl5 = new Label("Jumlah Soal");
				lbl5.setStyle("font-weight: bold");
				divKegiatan3.appendChild(lbl5);
				Label lbl6 = new Label(": " + data.getJumlahsoal());
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbe05 obj, String action, String memotim) {
		try {
			...
			new Tp2kbE05DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbe05> objList = oDao.listByFilter(filter, "tp2kbe05pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbe05 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbe05.zul");
		map.put("p2kb", obj);
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbe05Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbe05 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbE05DetailVm.this, "*");
					} catch (Exception e) {
