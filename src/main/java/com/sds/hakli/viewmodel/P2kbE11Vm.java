...
public class P2kbE11Vm {
	...
	@Wire
	private Window winP2kbe11;
	
	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, 
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbe11 objForm,
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbe11, map);
	...
	public Tp2kbe11 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbe11 objForm) {
		this.objForm = objForm;
	}
