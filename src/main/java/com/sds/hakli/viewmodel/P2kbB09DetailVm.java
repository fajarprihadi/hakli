...
public class P2kbB09DetailVm {
	...
	@Wire
	private Window winP2kbb09Detail;
	@Wire
	private Grid grid;
	...
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, @ExecutionArgParam("obj") Tp2kb p2kb,
		...
		System.out.println("TESSSS P2KBB09");
		...
		grid.setRowRenderer(new RowRenderer<Tp2kbb09>() {

			@Override
			public void render(Row row, Tp2kbb09 data, int index) throws Exception {
									...
									Messagebox.OK | Messagebox.CANCEL, Messagebox.QUESTION, new EventListener<Event>() {
										...
										public void onEvent(Event event) throws Exception {
											if (event.getName().equals("onOK")) {
												...
												BindUtils.postNotifyChange(P2kbB09DetailVm.this, "totalskp");
											}
										}
									});
						} else {
	...
	@NotifyChange("*")
	public void doSubmit(Tp2kbb09 obj, String action, String memotim) {
		try {
			...
			new Tp2kbB09DAO().save(session, obj);
	...
	public void doRefresh() {
		try {
			...
			List<Tp2kbb09> objList = oDao.listByFilter(filter, "tp2kbb09pk desc");
	...
	@Command()
	@NotifyChange("*")
	public void doEdit(Tp2kbb09 obj) {
		Map<String, Object> map = new HashMap<>();
		map.put("action", "edit");
		map.put("page", "p2kbb09.zul");
		map.put("p2kb", obj);
		map.put("book", p2kb.getTp2kbbook());
		map.put("p2kbkegiatan", obj.getMp2kbkegiatan());
		Event closeEvent = new Event("onClose", winP2kbb09Detail, map);
		Events.postEvent(closeEvent);
	}
	
	@Command()
	@NotifyChange("*")
	public void doDelete(Tp2kbb09 obj) {
			...
			public void onEvent(Event event)
				...
				if (event.getName().equals("onOK")) {
					...
					try {
						...
						doRefresh();
						BindUtils.postNotifyChange(P2kbB09DetailVm.this, "*");
					} catch (Exception e) {
