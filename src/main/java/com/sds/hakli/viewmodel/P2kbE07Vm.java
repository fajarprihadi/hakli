...
public class P2kbE07Vm {
	...
	@Wire
	private Window winP2kbe07;
	
	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, 
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbe07 objForm,
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbe07, map);
	...
	public Tp2kbe07 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbe07 objForm) {
		this.objForm = objForm;
	}
