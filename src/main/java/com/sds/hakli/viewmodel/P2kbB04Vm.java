...
public class P2kbB04Vm {
	
	private org.zkoss.zk.ui.Session zkSession = Sessions.getCurrent();
	private Tanggota anggota;
	private Tp2kbB04DAO oDao = new Tp2kbB04DAO();
	...
	@Wire
	private Window winP2kbb04;
	
	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view, 
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbb04 objForm,
	...
	public BigDecimal getNilaiSkp(Tp2kbb04 obj) throws Exception {
		BigDecimal skp = new BigDecimal(0);
		if (obj.getJeniskegiatan().equals("Surveilans") && obj.getStatuspeserta().equals("Ketua Tim")) {
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbb04, map);
	...
	public Tp2kbb04 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbb04 objForm) {
		this.objForm = objForm;
	}
