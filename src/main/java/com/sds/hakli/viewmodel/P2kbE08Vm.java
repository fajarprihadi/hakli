...
public class P2kbE08Vm {
	...
	@Wire
	private Window winP2kbe08;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbe08 objForm,
	...
	public BigDecimal getNilaiSkp(Tp2kbe08 obj) throws Exception {
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbe08, map);
	...
	public Tp2kbe08 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbe08 objForm) {
		this.objForm = objForm;
	}
