...
public class P2kbB20Vm {
	...
	public BigDecimal getNilaiSkp(Tp2kbb20 obj) throws Exception {
		...
		if (obj.getJeniskegiatan().equals("Pengurangan dan Penanganan Sampah Perundangan")
		...
		} else if (obj.getJeniskegiatan().equals("Mencegah Kontaminasi dari Penggunaan Zat Kimia")
				&& obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Mencegah Kontaminasi dari Penggunaan Zat Kimia")
				&& obj.getStatuspeserta().equals("Anggota Tim")) {
			skp = new BigDecimal(2);
				...
				&& obj.getStatuspeserta().equals("Kontributor")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Mencegah Pajanan dari Gangguan Fisik Udara")
				&& obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Mencegah Pajanan dari Gangguan Fisik Udara")
				&& obj.getStatuspeserta().equals("Anggota Tim")) {
