...
public class P2kbB16Vm {
	...
	public BigDecimal getNilaiSkp(Tp2kbb16 obj) throws Exception {
		...
		if (obj.getJeniskegiatan().equals("KIE (Perbadayaan Masyarakat)")
				&& obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("KIE (Perbadayaan Masyarakat)")
			...
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Rekayasa Lingkungan")
				&& obj.getStatuspeserta().equals("Anggota Tim")) {
			skp = new BigDecimal(2);
		} else if (obj.getJeniskegiatan().equals("Rekayasa Lingkungan")
				&& obj.getStatuspeserta().equals("Kontributor")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Pemeriksaan Kesehatan Penjamah Pangan")
				&& obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Pemeriksaan Kesehatan Penjamah Pangan")
				&& obj.getStatuspeserta().equals("Anggota Tim")) {
