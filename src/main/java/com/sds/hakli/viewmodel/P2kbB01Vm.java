...
public class P2kbB01Vm {
	...
	@Wire
	private Window winP2kbb01;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbb01 objForm,
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbb01, map);
	...
	public Tp2kbb01 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbb01 objForm) {
		this.objForm = objForm;
	}
