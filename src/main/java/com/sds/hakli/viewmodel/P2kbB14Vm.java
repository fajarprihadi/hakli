...
public class P2kbB14Vm {
	...
	public BigDecimal getNilaiSkp(Tp2kbb14 obj) throws Exception {
		...
		if (obj.getJeniskegiatan().equals("Air: Filtrasi, Sedimentasi, Airasi, Dekontaminasi")
				&& obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Air: Filtrasi, Sedimentasi, Airasi, Dekontaminasi")
				&& obj.getStatuspeserta().equals("Anggota Tim")) {
			skp = new BigDecimal(2);
		} else if (obj.getJeniskegiatan().equals("Air: Filtrasi, Sedimentasi, Airasi, Dekontaminasi")
				&& obj.getStatuspeserta().equals("Kontributor")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Pangan: KIE, Rekayasa Teknologi Pengolahan Pangan")
				&& obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Pangan: KIE, Rekayasa Teknologi Pengolahan Pangan")
				&& obj.getStatuspeserta().equals("Anggota Tim")) {
			skp = new BigDecimal(2);
				...
				&& obj.getStatuspeserta().equals("Kontributor")) {
			skp = new BigDecimal(1);
		} else if (obj.getJeniskegiatan().equals("Sarana dan Bangunan: KIE dan Pengembangan TTG")
				&& obj.getStatuspeserta().equals("Ketua Tim")) {
			skp = new BigDecimal(3);
		} else if (obj.getJeniskegiatan().equals("Sarana dan Bangunan: KIE dan Pengembangan TTG")
				&& obj.getStatuspeserta().equals("Anggota Tim")) {
