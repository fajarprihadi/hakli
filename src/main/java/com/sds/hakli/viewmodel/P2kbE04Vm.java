...
public class P2kbE04Vm {
	...
	@Wire
	private Window winP2kbe04;

	@AfterCompose
	public void afterCompose(@ContextParam(ContextType.VIEW) Component view,
			@ExecutionArgParam("obj") Mp2kbkegiatan p2kb, @ExecutionArgParam("objForm") Tp2kbe04 objForm,
	...
	public void doClose() {
		...
		Event closeEvent = new Event("onClose", winP2kbe04, map);
	...
	public Validator getValidator() {
		return new AbstractValidator() {
			...
			public void validate(ValidationContext ctx) {
				String statuspenguji = (String) ctx.getProperties("statuspenguji")[0].getValue();
				if (statuspenguji == null || "".equals(statuspenguji.trim()))
					this.addInvalidMessage(ctx, "statuspenguji", Labels.getLabel("common.validator.empty"));
	...
	public Tp2kbe04 getObjForm() {
		return objForm;
	}

	public void setObjForm(Tp2kbe04 objForm) {
		this.objForm = objForm;
	}
